...
<body>
  ...
  <div class="dropdown is-hoverable px-3 negativeMargin">
    ...
    <div class="dropdown-menu" id="dropdown-menu" role="menu">
      <div class="dropdown-content">
        ...
        <a href="/phpweb/templates/DTCs/P0400-P0499.php" class="dropdown-item is-active">
          P0400-P0499
        </a>
  ...
  <div class="container is-fluid my-6 is-flex is-justify-content-center">
    <table class="table is-hoverable">
      <caption class="is-size-3 has-text-weight-semibold">DTC Codes - P0400-P0499</caption>
      <caption class="is-size-5 mb-5 has-text-weight-medium">Auxiliary Emissions Controls</caption>
      <thead>
        <tr>
          <th>DTC</th>
          <th>Description</th>
      ...
      <tbody>
        <?php foreach($DctArray as $key => $val){ ?>
          <tr>
            <?php if(preg_match("/^[P]{1}\d{4}$/", $key) && substr($key, 1) >= 400 && substr($key, 1) <= 499) {?>
