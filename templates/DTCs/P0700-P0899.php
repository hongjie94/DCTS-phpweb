...
<body>
  ...
  <div class="dropdown is-hoverable px-3 negativeMargin">
    ...
    <div class="dropdown-menu" id="dropdown-menu" role="menu">
      ...
      <a href="/phpweb/templates/DTCs/P0001-P0199.php" class="dropdown-item">
        ...
        <a href="/phpweb/templates/DTCs/P0700-P0899.php" class="dropdown-item is-active">
          P0700-P0899
        </a>
      </div>
    </div>
  ...
  <div class="container is-fluid my-6 is-flex is-justify-content-center">
    <table class="table is-hoverable">
      <caption class="is-size-3 has-text-weight-semibold">DTC Codes - P0700-P0899</caption>
      <caption class="is-size-5 mb-5 has-text-weight-medium">Transmission</caption>
      <thead>
        <tr>
          <th>DTC</th>
          <th>Description</th>
      ...
      <tbody>
        <?php foreach($DctArray as $key => $val){ ?>
          <tr>
            <?php if(preg_match("/^[P]{1}\d{4}$/", $key) && substr($key, 1) >= 700 && substr($key, 1) <= 899) {?>
